#!/usr/bin/env python3
"""s03 - a deny, ask, allow permission gate before tool execution."""
...
def execute_tool(name: str, arguments: str) -> str:
    """Parse one OpenAI-compatible tool call and dispatch it by name."""
    ...
    print(f"\033[33m{name} {json.dumps(payload, ensure_ascii=False)}\033[0m")
    allowed, reason = check_permission(name, payload)
    if not allowed:
...
def main() -> None:
    ...
    print("s03: Permission (Alibaba Cloud Bailian)")
