"""s17 自治队友：团队通信、任务板接入和 WORK / IDLE 生命周期。"""
...
# s17 在 s16 的五种能力上增加看板查询、认领和完成，不开放派生 Agent。
    ...
    def _teammate_handlers(
        ...
        return {
            **self.file_handlers,
            ...
            "claim_task": lambda task_id: self.tasks.claim_task(task_id, sender),
            ...
            while not shutdown_requested:
                ...
                for _ in range(self.max_rounds):
                    ...
                    if not assistant.tool_calls:
                        ...
                        # 延续 s16 的 idle 生命周期；s17 同时等待消息和扫描新任务。
