#!/usr/bin/env python3
"""s17 CLI 入口：运行累计 Harness，并启用 Autonomous Agents。"""
...
from s17_autonomous_agents.harness.agent_loop import AgentHarness  # noqa: E402
from s17_autonomous_agents.harness.config import Settings  # noqa: E402
from s17_autonomous_agents.harness.provider import create_client  # noqa: E402
from s17_autonomous_agents.harness.system_prompt import SystemPromptAssembler  # noqa: E402
from s17_autonomous_agents.harness.tool_use import (  # noqa: E402
...
def main() -> None:
    ...
    print("s17: Autonomous Agents (Alibaba Cloud Bailian)")
    print(
