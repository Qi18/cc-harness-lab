#!/usr/bin/env python3
"""s16 CLI 入口：运行累计 Harness，并启用 Team Protocols。"""
...
from s16_team_protocols.harness.agent_loop import AgentHarness  # noqa: E402
from s16_team_protocols.harness.config import Settings  # noqa: E402
from s16_team_protocols.harness.provider import create_client  # noqa: E402
from s16_team_protocols.harness.system_prompt import SystemPromptAssembler  # noqa: E402
from s16_team_protocols.harness.tool_use import (  # noqa: E402
...
def main() -> None:
    ...
    print("s16: Team Protocols (Alibaba Cloud Bailian)")
    print(
