#!/usr/bin/env python3
"""s08 - layered context compaction with archival and recovery."""
...
def agent_loop(
    ...
    """Run the agent with layered preflight and reactive context compaction."""
...
def main() -> None:
    ...
    print("s08: Context Compact (Alibaba Cloud Bailian)")
    print(
