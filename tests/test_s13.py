...
from s13_background_tasks.harness import memory
from s13_background_tasks.harness.background_tasks import (
    COMPLETED,
    FAILED,
    BackgroundTaskManager,
)
from s13_background_tasks.harness.agent_loop import AgentHarness
from s13_background_tasks.harness.config import Settings
from s13_background_tasks.harness.error_recovery import (
    CONTINUATION_PROMPT,
    DEFAULT_MAX_TOKENS,
...
from s13_background_tasks.harness.subagent import SubagentRunner
from s13_background_tasks.harness.system_prompt import (
    SystemPromptAssembler,
    registered_tool_names,
)
from s13_background_tasks.harness.task_system import TaskManager
from s13_background_tasks.harness.todo_write import TodoManager
from s13_background_tasks.harness.tool_use import PARENT_TOOLS, SUB_TOOLS, ToolExecutor
...
class SystemPromptTest(unittest.TestCase):
    ...
    def test_modules_follow_course_capability_names(self):
        harness_dir = REPO_ROOT / "s13_background_tasks" / "harness"
