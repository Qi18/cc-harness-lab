...
from s17_autonomous_agents.harness import memory
from s17_autonomous_agents.harness.background_tasks import (
    COMPLETED,
    FAILED,
    BackgroundTaskManager,
)
from s17_autonomous_agents.harness.agent_loop import AgentHarness
from s17_autonomous_agents.harness.agent_teams import (
    TEAMMATE_TOOLS,
    AgentTeamManager,
    MessageBus,
    TeamMessage,
)
from s17_autonomous_agents.harness.config import Settings
from s17_autonomous_agents.harness.cron_scheduler import (
    CronJob,
    CronScheduler,
    cron_matches,
    validate_cron,
)
from s17_autonomous_agents.harness.error_recovery import (
    CONTINUATION_PROMPT,
    DEFAULT_MAX_TOKENS,
...
from s17_autonomous_agents.harness.subagent import SubagentRunner
from s17_autonomous_agents.harness.system_prompt import (
    SystemPromptAssembler,
    registered_tool_names,
)
from s17_autonomous_agents.harness.task_system import TaskManager
from s17_autonomous_agents.harness.team_protocols import TeamProtocolManager
from s17_autonomous_agents.harness.todo_write import TodoManager
from s17_autonomous_agents.harness.tool_use import PARENT_TOOLS, SUB_TOOLS, ToolExecutor
...
class SystemPromptTest(unittest.TestCase):
    ...
    def test_modules_follow_course_capability_names(self):
        harness_dir = REPO_ROOT / "s17_autonomous_agents" / "harness"
...
class AutonomousAgentsTest(unittest.TestCase):
    ...
    def test_idle_prioritizes_mail_over_claiming(self):
        from s17_autonomous_agents.harness.autonomous_agents import AutonomousWorker
