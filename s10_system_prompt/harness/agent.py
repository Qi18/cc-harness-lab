"""Agent loop composition with runtime-assembled system prompts."""
...
class AgentHarness:
    """One cumulative harness whose prompts are products of runtime state."""
    ...
    def refresh_system_prompts(
        ...
        """Rebuild only when tool, workspace, skill, or memory state changes."""
