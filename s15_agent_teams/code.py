#!/usr/bin/env python3
"""s15 CLI 入口：运行累计 Harness，并启用 Agent Teams。"""
...
from s15_agent_teams.harness.agent_loop import AgentHarness  # noqa: E402
from s15_agent_teams.harness.config import Settings  # noqa: E402
from s15_agent_teams.harness.provider import create_client  # noqa: E402
from s15_agent_teams.harness.system_prompt import SystemPromptAssembler  # noqa: E402
from s15_agent_teams.harness.tool_use import (  # noqa: E402
...
def main() -> None:
    ...
    print("s15: Agent Teams (Alibaba Cloud Bailian)")
    print(
