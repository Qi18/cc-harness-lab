#!/usr/bin/env python3
"""s19 CLI 入口：运行累计 Harness，并启用 MCP Tools (in-process mock)。"""
...
from s19_mcp_plugin.harness.agent_loop import AgentHarness  # noqa: E402
from s19_mcp_plugin.harness.config import Settings  # noqa: E402
from s19_mcp_plugin.harness.provider import create_client  # noqa: E402
from s19_mcp_plugin.harness.system_prompt import SystemPromptAssembler  # noqa: E402
from s19_mcp_plugin.harness.tool_use import (  # noqa: E402
...
def main() -> None:
    ...
    print("s19: MCP Tools (in-process mock) (Alibaba Cloud Bailian)")
    print(
